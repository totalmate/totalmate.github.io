document.addEventListener("DOMContentLoaded", () => {
    ...
    let products = [
        ...
        { name: 'Édesburgonya Krémleves Bacon Chipsszel', tag: 'sweetsoup', price: 1000, inCart: 0 },
        { name: 'Ázsiai Halászlé Harcsával Garnélával', tag: 'fishsoup', price: 1000, inCart: 0 },
        { name: 'Original Tokio Ramen', tag: 'ramen', price: 1000, inCart: 0 },
        ...
        { name: 'SOUL Cheese Steak Szendvics', tag: 'sandwich', price: 1000, inCart: 0 },
        { name: 'Lilahagymával Sült Sajtos Csirke Ropogós Bacon Tető Alatt', tag: 'onionchicken', price: 1000, inCart: 0 },
        { name: 'Mézes Chilis Csirke Fokhagymás Grillezett Zöldségekkel', tag: 'chilichicken', price: 1000, inCart: 0 },
        { name: 'Toszkán Sonkába Tekert Csirke Mozarella Salátával Sült Paradicsommal', tag: 'toscanchicken', price: 1000, inCart: 0 },
        { name: 'Sertés Oldalas BBQ Pit Box Sörben Sült Serpenyős Krumplival', tag: 'bbq', price: 1000, inCart: 0 },
        { name: 'Csülök Pékné Módra Tepsis Hagymás Krumplival', tag: 'csülök', price: 1000, inCart: 0 },
        { name: 'Roston Sült Csípős Lazac Steak Édesburgonya Chipsszel', tag: 'lazac', price: 1000, inCart: 0 },
        { name: 'Amerikai Palacsinta Csokis Málnapürével Erdei Gyümölcsökkel', tag: 'pancake', price: 1000, inCart: 0 },
        { name: 'Oreos Banános Cheesecake', tag: 'cheesecake', price: 1000, inCart: 0 },
        { name: 'Meggyes Aranygaluska Tiramisu', tag: 'tiramisu', price: 1000, inCart: 0 },
