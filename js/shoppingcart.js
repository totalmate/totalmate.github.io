document.addEventListener("DOMContentLoaded", () => {
    ...
    let products = [
        ...
        { name: 'Tigrisrák Gambas Pil Pil Bagettel', tag: 'gambas', price: 1000, inCart: 0 },
        { name: 'Marha Gulyásleves', tag: 'gulyas', price: 1000, inCart: 0 },
        { name: 'Toszkán Halleves', tag: 'fishsoup', price: 1000, inCart: 0 },
        { name: 'Tokio Ramen', tag: 'ramen', price: 1000, inCart: 0 },
        ...
        { name: 'Mézes Chilis Csirke Édesburgonya Chipsszel Fokhagymás Mártogatóssal', tag: 'chilichicken', price: 1000, inCart: 0 },
        ...
        { name: 'Mediterrán Lecsó Sertésszűzzel', tag: 'lecso', price: 1000, inCart: 0 },
        { name: 'Grillezett Lazac Steak Zöldségekkel Hollandi Mártással', tag: 'lazac', price: 1000, inCart: 0 },
